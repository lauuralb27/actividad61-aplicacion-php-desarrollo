...
$resultado = $mysqli->query("SELECT * FROM maillots ORDER BY maillot_id, nombre");
...
Este forma de pasar el dato se conoce como: método GET*/
		echo "<a href=\"edit.php?idempleado=$fila[maillot_id]\">Edición</a>\n";
		echo "<a href=\"delete.php?idempleado=$fila[maillot_id]\" onClick=\"return confirm('¿Está segur@ que desea eliminar el maillot?')\" >Baja</a></td>\n";
		echo "</td>";
		echo "</tr>\n";
	}//fin mientras
 }//fin si
?>
	...
	<footer>
    	Created by Laura Alonso &copy; 2025
  	</footer>
</div>
</body>
</html>
